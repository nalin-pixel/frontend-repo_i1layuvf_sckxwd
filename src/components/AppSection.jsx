  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-2xl border border-slate-200 p-8 bg-white text-center">
          <h2 className="text-3xl font-bold text-slate-900 tracking-tight">التطبيق</h2>
          <p className="mt-2 text-slate-600">حمل التطبيق الآن للحصول على أولوية الاستثمار.</p>
