    ...
    <div className="pt-24 pb-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-4 grid sm:grid-cols-3 gap-4 text-slate-800">
          <div className="rounded-2xl border border-slate-200 bg-white/60 backdrop-blur-xl p-6">استثمار مشترك — لا نحصل على رسومنا إلا بعد توزيع أرباحكم.</div>
          <div className="rounded-2xl border border-slate-200 bg-white/60 backdrop-blur-xl p-6">شفافية ووضوح — نعرض التفاصيل وأسباب الموافقة بوضوح تام.</div>
          <div className="rounded-2xl border border-slate-200 bg-white/60 backdrop-blur-xl p-6">فرص مختارة — لا نطرح إلا ما اجتاز التحليل والدراسة الشاملة.</div>
        </div>
      </div>
    </div>
  )
