    ...
    <div className="pt-24 pb-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-4 grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          {team.map((m) => (
            <div key={m.name} className="rounded-2xl border border-slate-200 bg-white/60 backdrop-blur-xl p-6 text-center">
        ...
        <div className="mt-10 rounded-2xl border border-slate-200 bg-white/60 backdrop-blur-xl p-6">
