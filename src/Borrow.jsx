    ...
    <div className="pt-24 pb-12 bg-white min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-4 grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="rounded-2xl border border-slate-200 bg-white p-6">بيانات مالية حديثة — قوائم مالية مدققة للعامين الماضيين</div>
          <div className="rounded-2xl border border-slate-200 bg-white p-6">سجل تجاري نشط — ساري وغير مجمد</div>
          <div className="rounded-2xl border border-slate-200 bg-white p-6">الحد الأدنى للتمويل — لا يقل عن 500,000 ريال</div>
          <div className="rounded-2xl border border-slate-200 bg-white p-6">هوية المالك/المخوّل — سارية المفعول</div>
        </div>
